...
mutants_x_is_dispatchable__mutmut: MutantDict = {}  # type: ignore


@_mutmut_mutated(mutants_x_is_dispatchable__mutmut)
...
def x_is_dispatchable__mutmut_orig(entry: RuleEntry) -> bool:
    """True iff ``entry`` has a real check to run.
...
def x_is_dispatchable__mutmut_1(entry: RuleEntry) -> bool:
    """True iff ``entry`` has a real check to run.
    ...
    every dispatch mode.
    """
    return entry.status != PROPOSED_STATUS or entry.check != "(proposed)"


def x_is_dispatchable__mutmut_2(entry: RuleEntry) -> bool:
    """True iff ``entry`` has a real check to run.
...
def x_is_dispatchable__mutmut_3(entry: RuleEntry) -> bool:
    """True iff ``entry`` has a real check to run.
...
def x_is_dispatchable__mutmut_4(entry: RuleEntry) -> bool:
    """True iff ``entry`` has a real check to run.
    ...
    every dispatch mode.
    """
    return entry.status != PROPOSED_STATUS and entry.check != "XX(proposed)XX"


def x_is_dispatchable__mutmut_5(entry: RuleEntry) -> bool:
    """True iff ``entry`` has a real check to run.
...
mutants_x_is_dispatchable__mutmut['_mutmut_orig'] = x_is_dispatchable__mutmut_orig # type: ignore # mutmut generated
mutants_x_is_dispatchable__mutmut['x_is_dispatchable__mutmut_1'] = x_is_dispatchable__mutmut_1 # type: ignore # mutmut generated
mutants_x_is_dispatchable__mutmut['x_is_dispatchable__mutmut_2'] = x_is_dispatchable__mutmut_2 # type: ignore # mutmut generated
mutants_x_is_dispatchable__mutmut['x_is_dispatchable__mutmut_3'] = x_is_dispatchable__mutmut_3 # type: ignore # mutmut generated
mutants_x_is_dispatchable__mutmut['x_is_dispatchable__mutmut_4'] = x_is_dispatchable__mutmut_4 # type: ignore # mutmut generated
mutants_x_is_dispatchable__mutmut['x_is_dispatchable__mutmut_5'] = x_is_dispatchable__mutmut_5 # type: ignore # mutmut generated
